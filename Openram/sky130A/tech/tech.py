...
spice["fet_models"] = {"TT": [SPICE_MODEL_DIR + "/corners/tt.sp"],
                       "FF": [SPICE_MODEL_DIR + "/corners/ff.sp"],
                       "FS": [SPICE_MODEL_DIR + "/corners/ff.sp"],
                       "SF": [SPICE_MODEL_DIR + "/corners/ss.sp"],
                       "SS": [SPICE_MODEL_DIR + "/corners/ss.sp"],
                       "ST": [SPICE_MODEL_DIR + "/corners/ss.sp"],
                       "TS": [SPICE_MODEL_DIR + "/corners/tt.sp"],
                       "FT": [SPICE_MODEL_DIR + "/corners/ff.sp"],
                       "TF": [SPICE_MODEL_DIR + "/corners/tt.sp"],
                       }
